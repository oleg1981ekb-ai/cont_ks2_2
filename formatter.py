...
def apply_conditional_formatting(ws):
    ...
    ws.conditional_formatting.add("D2:F1000", CellIsRule(operator='equal', formula=['1'], fill=f_grn, font=font_grn))
    ws.conditional_formatting.add("D2:F1000", CellIsRule(operator='equal', formula=['2'], fill=f_ylw, font=font_ylw))
    ws.conditional_formatting.add("D2:F1000", CellIsRule(operator='equal', formula=['3'], fill=f_red, font=font_red))
